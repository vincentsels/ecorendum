...
export class TargetsService {
  ...
  getTargetsByContext(context: ContextType): Targets {
    if (context === 'flanders') {
      return new Targets(
        new Target(73400, 39060, 34300), // Number VEKA
        new Target(43700, 26700, 17000), // 50.4 (2005 ESR) - 47% (23.7) = 26.7 target in 2030. 2021 = 43.7 - 26.7 (target) = 17.0 gap
        ...
        new Target(278000, 201000, 77000),
        new Target(25820, 29820, 4000), // TODO
      );
    } else if (context === 'brussels') {
      return new Targets(
        new Target(73400 / 10, 39060 / 10, 34300 / 10), // TODO
        new Target(43700 / 10, 26700 / 10, 17000 / 10), // TODO
        new Target(278000 / 10, 201000 / 10, 77000 / 10),
        new Target(25820 / 10, 29820 / 10, 4000 / 10), // TODO
      );
    } else if (context === 'wallonia') {
      return new Targets(
        new Target(73400 / 2, 39060 / 2, 34300 / 2), // Number VEKA
        new Target(43700 / 2, 26700 / 2, 17000 / 2), // TODO
        new Target(278000 / 2, 201000 / 2, 77000 / 2), // TODO
        new Target(25820 / 2, 29820 / 2, 4000 / 2), // TODO
      );
    } else {
